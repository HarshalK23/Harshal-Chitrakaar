...
public class RateApp extends Activity implements RatingBar.OnRatingBarChangeListener,View.OnClickListener{
    ...
    public void onClick(View v) {
        ...
        Intent i=new Intent(RateApp.this, Choose.class);
        startActivity(i);
    } }
